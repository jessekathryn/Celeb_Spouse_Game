...
class CelebritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create celebrity" do
    assert_difference('Celebrity.count') do
      post celebrities_url, params: { celebrity: { birth_year: @celebrity.birth_year, fame_type: @celebrity.fame_type, gender: @celebrity.gender, info: @celebrity.info, name: @celebrity.name, picture: @celebrity.picture } }
    end
  ...
  test "should update celebrity" do
    patch celebrity_url(@celebrity), params: { celebrity: { birth_year: @celebrity.birth_year, fame_type: @celebrity.fame_type, gender: @celebrity.gender, info: @celebrity.info, name: @celebrity.name, picture: @celebrity.picture } }
